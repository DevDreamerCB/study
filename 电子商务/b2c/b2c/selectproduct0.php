...
<script language=javascript>
	function addorder()
	{
        ...
        for(i=0;i<checkboxes.length;i++){ 
         ...
         //alert(document.getElementById("checkedproduct").value); return;        
         if((""==str)){
...
<td><?php echo "<img style='width: 100px; height:100px;' src=" . $RS["productimage"].">"?></td>
</tr>
