...
//		echo $SQL;
	...
	header("location:sqlserver.php?currentpage=" . strval($currentpage) . "&selname=" . strval($selname));
}
...
window.location="sqlserveraccess.php?currentpage=<?php echo strval($currentpage)?>&selname=<?php echo strval($selname)?>";
}
//-->
</SCRIPT>
</head>
...
<br><center>
<form id=form1 name=form1 action=sqlserveruseradd.php method=post LANGUAGE=javascript onsubmit="return form1_onsubmit()">
